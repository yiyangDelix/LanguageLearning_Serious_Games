...
namespace UnityEngine.UI.TableUI
{
    ...
    public class TableUI : MonoBehaviour
    {
        ...
        public TextMeshPro GetCell(int row, int column)
        {
        ...
        private void GenerateRow(string name, int n)
        {
            ...
            list.list = new List<TextMeshPro>();
        ...
        private TextMeshPro GenerateColumnInRow(string name, GameObject row, int rowN, int columnN)
        {
        ...
        [System.Serializable]
        public class TextMeshList : ListWrapper<TextMeshPro> { }
